...
public class GUIitemsControl : MonoBehaviour {
	...
	void Start () {
		...
		if (isForP1){goals = SpacecraftItemControl.Inst.goalsP1;}
		else{goals = SpacecraftItemControl.Inst.goalsP2;}
	...
	void Update () {
		...
		{
            te += bpack.getItemNum(str) + "/" + goals[i] + "\t\t";
			i++;
		}
